  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-6 max-w-4xl">
        ...
        <Card>
          <CardHeader><CardTitle>Moneda de referencia</CardTitle></CardHeader>
          <CardBody className="flex flex-col gap-4">
            <Select
              label="Moneda principal para tus precios"
            ...
            <div className="text-xs text-text-muted -mt-2">
              La tasa de cambio la gestiona el administrador de la plataforma y se aplica automáticamente. Vas a ver el valor vigente en la barra superior.
            </div>
            <div className="bg-info-subtle border border-info/30 rounded-md p-3 flex items-start gap-2 text-sm">
              <Info size={16} className="text-info shrink-0 mt-0.5" />
              <div>
                <div className="text-info font-medium">Sobre la tasa de cambio</div>
                <div className="text-xs text-text-secondary mt-1">
                  La tasa BCV (USD y EUR) es global y se actualiza desde la administración central de la plataforma. Todos los merchants consumen el mismo valor para mantener consistencia y evitar diferencias de precio.
                </div>
              </div>
            </div>
          </CardBody>
